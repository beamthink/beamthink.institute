-- Fix the ai_advisors table structure
-- Run this in your Supabase SQL editor

-- First, let's see what's in the table
SELECT * FROM ai_advisors LIMIT 5;
...
CREATE TABLE ai_advisors (
  ...
  avatar TEXT,
  specialties TEXT[], -- Use TEXT array instead of JSON
...
-- Insert the advisor data with proper array format
...
SELECT slug, full_name, specialties FROM ai_advisors;
